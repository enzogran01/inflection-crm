...
<style>
    ...
    :is(.dark .ff-column) {
        ...
        border-color: rgba(255, 255, 255, 0.1) !important; /* white/10 */
    }
    ...
    .kanban-header-danger {
        ...
        border-bottom-color: rgba(var(--danger-200), 1);
    }
    .kanban-header-danger .ff-column__title { color: rgba(var(--danger-700), 1); }
    :is(.dark .kanban-header-danger) {
        background-color: rgba(var(--danger-500), 0.1);
        border-bottom-color: rgba(var(--danger-500), 0.2);
    }
    :is(.dark .kanban-header-danger .ff-column__title) { color: rgba(var(--danger-400), 1); }

    /* Header Primary (Em Andamento) */
    .kanban-header-primary {
        background-color: rgba(var(--primary-50), 1);
        border-bottom-color: rgba(var(--primary-200), 1);
    }
    .kanban-header-primary .ff-column__title { color: rgba(var(--primary-700), 1); }
    :is(.dark .kanban-header-primary) {
        background-color: rgba(var(--primary-500), 0.1);
        border-bottom-color: rgba(var(--primary-500), 0.2);
    }
    :is(.dark .kanban-header-primary .ff-column__title) { color: rgba(var(--primary-400), 1); }

    /* Header Warning (Em Revisão) */
    .kanban-header-warning {
        background-color: rgba(var(--warning-50), 1);
        border-bottom-color: rgba(var(--warning-200), 1);
    }
    .kanban-header-warning .ff-column__title { color: rgba(var(--warning-700), 1); }
    :is(.dark .kanban-header-warning) {
        background-color: rgba(var(--warning-500), 0.1);
        border-bottom-color: rgba(var(--warning-500), 0.2);
    }
    :is(.dark .kanban-header-warning .ff-column__title) { color: rgba(var(--warning-400), 1); }

    /* Header Success (Concluído) */
    .kanban-header-success {
        background-color: rgba(var(--success-50), 1);
        border-bottom-color: rgba(var(--success-200), 1);
    }
    .kanban-header-success .ff-column__title { color: rgba(var(--success-700), 1); }
    :is(.dark .kanban-header-success) {
        background-color: rgba(var(--success-500), 0.1);
        border-bottom-color: rgba(var(--success-500), 0.2);
    }
    :is(.dark .kanban-header-success .ff-column__title) { color: rgba(var(--success-400), 1); }
    .ff-column__count {
